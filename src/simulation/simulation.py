...
from extractions.convert_mininet_to_nx import convert_mininet_to_nx
...
def run_simulation(nx_graph):
    ...
    link_failure_thread = threading.Thread(
        ...
        args=(net,),
        kwargs={'fail_prob':0.3, 'recover_prob':0.3, 'sleep_interval':5},
        daemon=True
    )
